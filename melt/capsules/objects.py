def run(data):
    ...
    connectivity = get(data, 'connectivity', 4)
    require(is_int(background), 'background must be an integer color')
    require(connectivity in [4, 8], 'connectivity must be 4 or 8')
