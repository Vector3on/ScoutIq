...
#
# This version removes the duplicate project entry.
...
PROJECT_LIST = [
    ...
    # "jmorganca/ollama", <- Removed duplicate entry
...
class GitHubScraper:
    ...
    def scrape_and_update(self):
        ...
        with self.driver.session(database="neo4j") as session:
            # Using set to programmatically handle any accidental duplicates in the list
            unique_projects = set(PROJECT_LIST)
        ...
        print(f"    - GitHub: Processed {len(unique_projects)} projects, creating/updating nodes with project_id.")
